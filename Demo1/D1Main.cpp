...
// File: Main.cpp
//
// This is the template of AEro Engine games.
//
// Feel free to use this code for reference.
//
// Author Name : mriiiron
// Author URL  : http://mriiiron.sykeval.org
//--------------------------------------------------------------------------------------
...
#include "Classes\D1Sprite.h"
#include "Classes\D1Scene.h"
#include "Classes\D1FileReader.h"
#include "Classes\D1HeadUpDisplay.h"
...
HRESULT InitWindow(HINSTANCE hInstance, int nCmdShow)
{
    ...
    g_hWnd = CreateWindow(L"AEroWindowClass", L"Demo 1", WS_OVERLAPPEDWINDOW,
...
void LoadGameResources() {
    ...
    // Load Resources
    D1DataFileReader::loadResources("Resources\\resources.txt");

    // Load Fonts
    xtk_SpriteFont_Arial_10 = new SpriteFont(g_pd3dDevice, L"Resources\\arial_10.spritefont");

    // Load Objects
    D1DataFileReader::loadObject(0, "Resources\\fighter_0.txt");
    D1DataFileReader::loadObject(1, "Resources\\fighter_1.txt");
    D1DataFileReader::loadObject(2, "Resources\\fighter_2.txt");
    D1DataFileReader::loadObject(5, "Resources\\bullets.txt");
    D1DataFileReader::loadObject(10, "Resources\\effects.txt");

    // Load Backgrounds
    AEDataFileReader::loadBackground(0, "Resources\\bg_sea.txt");
...
void InitGameplay() {
    ...
    // Create HUD
    D1HeadUpDisplay* hud = new D1HeadUpDisplay(0);

    // Create Scene
    AERO_SCENE_DESC descScene;
    descScene.spriteTableSize = 200;
    descScene.bg = ae_BackgroundTable.getItem(0);
    descScene.hud = hud;
    D1Scene* scene = new D1Scene(descScene);
