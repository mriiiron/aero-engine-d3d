...
#include "Classes\D2Sprite.h"
#include "Classes\D2Scene.h"
...
HRESULT InitWindow(HINSTANCE hInstance, int nCmdShow)
{
    ...
    g_hWnd = CreateWindow(L"AEroWindowClass", L"Demo 2", WS_OVERLAPPEDWINDOW,
...
void LoadGameResources() {
    ...
    // Load Resources
    AEDataFileReader::loadResources("Resources\\resources.txt");

    // Load Fonts
    xtk_SpriteFont_Arial_10 = new SpriteFont(g_pd3dDevice, L"Resources\\arial_10.spritefont");

    // Load Objects
    AEDataFileReader::loadObject(0, "Resources\\hellcow.txt");

    // Load Backgrounds
    AEDataFileReader::loadBackground(0, "Resources\\bg_grass.txt");
...
void InitGameplay() {
    ...
    descScene.spriteTableSize = 100;
    descScene.bg = ae_BackgroundTable.getItem(0);
    descScene.hud = nullptr;
    D2Scene* scene = new D2Scene(descScene);
...
void Render() {
    ...
    xtk_SpriteFont_Arial_10->DrawString(xtk_SpriteBatch, strSpriteCount, XMFLOAT2(-200.0f, 130.0f), XMVectorSet(1.0f, 1.0f, 1.0f, 1.0f));
    xtk_SpriteBatch->End();
